                            ...
                            int expandValue)
{
    ...
    QRect oldBounds = replaceImage->mBounds;
    QRect newBounds;
    ...
    while (xCoords.hasNext()) {
        ...
        while (yCoords.hasNext()) {
            yCoords.next();
            replaceImage->scanLine(xCoords.key() + oldBounds.left(), yCoords.key() + oldBounds.top(), fillColor);
        }
    }
                                                          ...
                                                          QRect& newBounds)
{
    ...
    while (!queue.empty())
    {
        ...
        int xCoord = xTemp - targetImage->mBounds.left();
        int yCoord = point.y() - targetImage->mBounds.top();
               ...
               newPlacedColor != fillColor)
        {
            ...
            xCoord = xTemp - targetImage->mBounds.left();
            yCoord = point.y() - targetImage->mBounds.top();
            // Set pixel color
